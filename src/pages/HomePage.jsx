...
import { Modal, ModalActive, ModalBackground } from '../component/Modal'
  ...
  return (
    <>
      <div className="mainContainer">
        <LeftContainer home={homeActive} onClick={handleClick}>'</LeftContainer>
        ...
        <div className="centerContainer">
          ...
          <Modal active={postingModal} onCancel={handleCancel}></Modal>
        </div>
